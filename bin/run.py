...
class Runner:
	...
	def send_mail(self,smtp_server,sender,psw,receiver,port):
		'''
		发送邮件内容
		...
		# server.login(send_user,psw)
		# server.sendmail(send_user,receiver,message.as_string())
		# server.close()
	...
	def main_run(self):
		...
		self.send_mail(smtp_server,sender,psw,receiver,port)
